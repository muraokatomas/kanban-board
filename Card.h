...
namespace KanbanBoardCard {
	 ...
	 * Postcondición: Agrega un nuevo comentario, @comment, en @card. El @comment es agregado como last comentario.
	 */
	...
	/*
	 * Precondición: @card fue creado con la primitiva KanbanBoardCard::CreateCard.
	 * Postcondición: Cambia el estado de @card por @state
	 */
	void SetState(Card* card, State* state);

	/*
	 * Precondición: @card fue creado con la primitiva KanbanBoardCard::CreateCard.
	 * Postcondición: Obtiene el estado de @card
	 */
